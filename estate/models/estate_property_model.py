...
class EstateProperty(models.Model):
    ...
    _sql_constraints = [
        ...
        ("check_expected_price", "CHECK(selling_price >= 0)", "The expected price must be positive")
    ]
    ...
    price_ids = fields.One2many("estate.property.offer", "property_id", string="Price")
